...
import sk.zimen.semestralka_1_kotlin.data.Place
import sk.zimen.semestralka_1_kotlin.data.PlaceKey
import sk.zimen.semestralka_1_kotlin.quadtree.boundary.Boundary
import sk.zimen.semestralka_1_kotlin.quadtree.boundary.Position
import sk.zimen.semestralka_1_kotlin.quadtree.interfaces.NodeIterator
import sk.zimen.semestralka_1_kotlin.quadtree.node.AdvancedNode
import sk.zimen.semestralka_1_kotlin.quadtree.node.Node
import sk.zimen.semestralka_1_kotlin.utils.GeneratedSize
import sk.zimen.semestralka_1_kotlin.utils.Generator
...
internal class QuadTreeTest {
    ...
    private val classicTree: ClassicQuadTree<PlaceKey, Place> = ClassicQuadTree(80)
    private val advancedTree: AdvancedQuadTree<PlaceKey, Place> = AdvancedQuadTree(80)
    ...
    @Order(2)
    fun testFind() {
        this.testFind(classicTree)
        this.testFind(advancedTree)
    }
